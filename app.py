...
def index():
    ...
    if request.method == 'POST':
        ...
        # insert_data(mobile, name, float(score))
        rank = int(180474 - (float(score) * 180474 / 100)) + 1

    return render_template('index.html', rank=rank, mobile=mobile, name=name, score=score)
